...
public class Thresholding extends JApplet {

    Image edgeImage, accImage, outputImage;
    MediaTracker tracker = null;
    PixelGrabber grabber = null;
    int width = 0, height = 0;
    String fileNames[] = {"lena.png", "baboon.png"};//, "screw.png", "drawing.png", "film.png"};
    ...
    JRadioButton standardRadio, hystRadio;
    ...
    public void init() {
        ...
        timer = new javax.swing.Timer(100, new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                if (mode == 1) {
                    ...
                    progressBar.setValue((edgedetector.getProgress() + hystThreshObject.getProgress()) / 2);
                }
            }
        });

        origLabel = new JLabel("Edge Detected Image", new ImageIcon(image[imageNumber]), JLabel.CENTER);
        ...
        hystRadio = new JRadioButton("Hysteresis");
        hystRadio.setActionCommand("hyst");
