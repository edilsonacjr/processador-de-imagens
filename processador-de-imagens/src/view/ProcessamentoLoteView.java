 ...
 * @author edilson
 */
public class ProcessamentoLoteView extends javax.swing.JFrame {
     ...
     */
    public ProcessamentoLoteView(Principal p, ArrayList<Imagem> imagens) {
        noise = 0;
        templateSize = 1;
        noiseType = "Gaussian";
        lowpass = false;
        ...
        try {
            ...
            if (output == null) {
                ...
                try {
                    ...
                    Logger.getLogger(ProcessamentoLoteView.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProcessamentoLoteView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProcessamentoLoteView().setVisible(true);
            }
        });
    }
